...
namespace LinqTestable.Sources
{
    ...
    class MainQueryChanger : ExpressionVisitor, IQueryChanger
    {
        public Expression Change(Expression sourceExpression)
        {
            ...
            expression = AddFinalSelect(expression, returnType, typesToReplace, maxNewNestDeep);
        ...
        private Expression AddFinalSelect(Expression sourceExpression, Type returnType, List<Type> typesToReplace, int maxNewNestDeep)
        {
